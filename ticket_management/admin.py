...
class TicketAdmin(admin.ModelAdmin):
    list_display = ('customer', 'from_location', 'to_location', 'departure_date', 'ticket_class', 'quantity', 'note', 'amount', 'received', 'payment', 'paid', 'terminated', 'created_at', 'updated_at')
